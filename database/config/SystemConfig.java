...
import cn.tentact.nebula.company.CompanyController;
import cn.tentact.nebula.jobseeker.JobseekerController;
import cn.tentact.nebula.recruit.RecruitController;
...
public class SystemConfig extends JFinalConfig {
	...
	public void configPlugin(Plugins plugins) {
		...
		arp.addSqlTemplate("recruit.sql");
		arp.addSqlTemplate("company.sql");
	...
	public void configRoute(Routes routes) {
		...
		routes.add("/recruit",RecruitController.class);
